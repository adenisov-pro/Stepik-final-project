...
class LoginPageLocators:
    ...
    PASSWORD2 = (By.CSS_SELECTOR, "input#id_registration-password2.form-control")
    REGISTRATION_BUTTON = (By.CSS_SELECTOR, "button[name='registration_submit'].btn.btn-lg.btn-primary")
